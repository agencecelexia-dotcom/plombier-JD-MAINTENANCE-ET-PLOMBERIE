...
export const services: AdminService[] = [
  {
    ...
    fullDescription: "Fuite d'eau, canalisation bouchée, dégât des eaux, panne de chaudière... Jimmy intervient en urgence 7j/7 dans le Nord-Isère. Diagnostic sur place et réparation immédiate dans la majorité des cas.",
  ...
  },
  {
    ...
    fullDescription: "Robinetterie, tuyauterie, raccordements, WC, éviers, recherche de fuite... JD Maintenance intervient pour tous vos travaux de plomberie, de l'installation neuve à la mise aux normes de vos installations existantes.",
  ...
  },
  {
    ...
    fullDescription: "De la conception à la réalisation, Jimmy prend en charge votre projet de rénovation de salle de bain. Douche italienne, remplacement baignoire, accessibilité PMR, meuble vasque... Un interlocuteur unique du début à la fin.",
  ...
  },
  {
    ...
    slug: "maintenance",
    title: "Maintenance",
    shortDescription: "Contrats d'entretien et maintenance préventive de vos installations.",
    fullDescription: "L'entretien régulier de vos installations de plomberie et chauffage est essentiel. JD Maintenance propose des contrats d'entretien incluant la visite annuelle, le dépannage prioritaire et les pièces d'usure.",
