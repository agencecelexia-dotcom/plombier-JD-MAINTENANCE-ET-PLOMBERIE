...
export const realisations: Realisation[] = [
  ...
  },
  {
    ...
    description:
      "Intervention d'urgence pour une fuite sur canalisation d'eau chaude dans une maison ancienne.",
    beforePrompt:
